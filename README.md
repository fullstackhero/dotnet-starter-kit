...
- Want the deeper story? The full documentation site now lives in its own repo: [**fullstackhero/docs**](https://github.com/fullstackhero/docs) (Astro Starlight). Clone it and run `npm install && npm run dev` to read it locally.
