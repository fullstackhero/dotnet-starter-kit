    ...
    <div className="space-y-6 fsh-enter">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Pick a colour mode for the admin. System follows your OS.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        ...
        <CardContent className="flex items-center justify-between gap-4 px-6 pb-5 pt-1">
          <div className="text-sm text-[var(--color-muted-foreground)]">
            Use compact spacing across the admin.
          </div>
          <Switch
...
// admin chrome rendered in the candidate accent.
// ───────────────────────────────────────────────────────────────────────
