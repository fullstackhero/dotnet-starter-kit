    ...
    internal static ConfigureHostBuilder AddConfigurations(this ConfigureHostBuilder host)
    {
        host.ConfigureAppConfiguration((context, config) =>
        {
            ...
            config.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/featureflags.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/featureflags.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/staticfiles.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/staticfiles.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
