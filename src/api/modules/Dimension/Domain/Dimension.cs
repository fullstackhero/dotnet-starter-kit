...
using FSH.Starter.WebApi.Setting.Dimension.Domain.Events;

namespace FSH.Starter.WebApi.Setting.Dimension.Domain;
public class Dimension : AuditableEntity, IAggregateRoot
{
        ...
        Guid? fatherId)
    {
        ...
        this.QueueDomainEvent(new DimensionUpdated(this));
