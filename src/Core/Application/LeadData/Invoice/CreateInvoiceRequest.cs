...
public class CreateInvoiceRequestHandler : IRequestHandler<CreateInvoiceRequest, DefaultIdType>
{
    ...
    public CreateInvoiceRequestHandler(IRepositoryWithEvents<InvoiceDetailsModel> repository) => _repository = repository;

    public async Task<DefaultIdType> Handle(CreateInvoiceRequest request, CancellationToken cancellationToken)
    {
