...
namespace DN.WebApi.Infrastructure.Headers;

internal static class Startup
{
    internal static IApplicationBuilder UseHeaders(this IApplicationBuilder app, IConfiguration config)
    {
        var settings = config.GetSection(nameof(HeadersSettings)).Get<HeadersSettings>();
